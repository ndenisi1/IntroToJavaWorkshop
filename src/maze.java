...
if(mouseColor==wonderwoman)	{
	...
	if(mouseColor==batman){
		...
		private void scare() {
			...
			AudioClip sound = JApplet.newAudioClip(getClass().getResource("yay.wav"));
